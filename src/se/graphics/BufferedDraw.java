...
public class BufferedDraw {
    public static float[] vertices = new float[24];

    public static void rectCenter(Texture texture, float x, float y, float width, float height) {
        rect(texture, x - width / 2.0F, y - height / 2.0F, width, height);
    }
    ...
    public static void drawBuffer(@NotNull FrameBuffer buffer, float centerX, float centerY, float width, float height) {
    ...
    public static void rect(Texture texture, float x, float y, float width, float height) {
        ...
        quad(texture, x, y, color, 0.0F, 1.0F, x, y + height, color, 0.0F, 0.0F, x + width, y + height, color, 1.0F, 0.0F, x + width, y, color, 1.0F, 1.0F);
    }
